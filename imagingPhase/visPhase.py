...
class DomainColoring:
    ...
    def _set_defualt_clrset():
        ...
        clrset = [
            [(0.847, 0.655, 0.655), (0.847, 0.765, 0.647), (0.784, 0.847, 0.655)],
            [(0.655, 0.847, 0.784), (0.655, 0.784, 0.847), (0.655, 0.655, 0.847)],
            [(0.765, 0.647, 0.847), (0.847, 0.655, 0.784), (0.796, 0.733, 0.686)],
        ]
        clrset = [
            [(0.92, 0.74, 0.74), (0.93, 0.84, 0.72), (0.84, 0.93, 0.74)],
            [(0.74, 0.93, 0.84), (0.74, 0.84, 0.93), (0.76, 0.74, 0.93)],
            [(0.84, 0.74, 0.93), (0.93, 0.74, 0.84), (0.90, 0.84, 0.80)],
        ]
